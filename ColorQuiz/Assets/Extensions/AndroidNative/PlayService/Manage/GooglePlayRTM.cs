...
public class GooglePlayRTM : SA_Singleton<GooglePlayRTM>  {
	...
	private void OnWatingRoomIntentClosed(string status) {

		AndroidActivityResult result =  new AndroidActivityResult(status);
	...
	private void OnInvitationBoxUiClosed(string status) {
